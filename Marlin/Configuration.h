...
#define CUSTOM_MACHINE_NAME "SuperEnder3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.6, 80.4, 402, 655 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 50 //X_CENTER  // X point for Z homing
